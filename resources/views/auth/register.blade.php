                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="ciudad" id="ciudad" class="form-control{{ $errors->has('ciudad') ? ' is-invalid' : '' }}" required>
                                    <option value="" selected disabled>...</option>
                                    @foreach ($ciudad as $element)
                                        <option value="{{ $element->id }}">{{ $element->nombreCiudad }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                <select name="role" id="role" class="form-control{{ $errors->has('role') ? ' is-invalid' : '' }}" required>
                                    ...
                                    @foreach ($roles as $element)
                                        <option value="{{ $element->id }}">{{ $element->namePerfil }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('role'))
                                    <span class="invalid-feedback" role="alert">
